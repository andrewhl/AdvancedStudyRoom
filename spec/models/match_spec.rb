...
describe Match do
  ...
  let!(:empty_division_ruleset) { FactoryGirl.create(:empty_division_ruleset) }
  ...
  describe "validation failures" do
    ...
    #   let!(:second_match) { FactoryGirl.create(:second_match) }
  ...
  describe "without canonical ruleset" do
    ...
    let!(:event_ruleset) { FactoryGirl.create(:event_ruleset) }
    let!(:tier_ruleset) { FactoryGirl.create(:tier_ruleset) }
    let!(:division_ruleset) { FactoryGirl.create(:empty_division_ruleset) }
