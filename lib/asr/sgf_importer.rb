    ...
    private
      ...
      def build_matches(sgf_data_list)
        sgf_data_list.collect do |sgf_data|
          w_player = Registration.find_by_handle_and_server_id(sgf_data.white_player, server.id)
          b_player = Registration.find_by_handle_and_server_id(sgf_data.black_player, server.id)
